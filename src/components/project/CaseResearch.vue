          ...
          <li class="">
            <article class="w-96">
              <div class="">
                ...
                <p class="pt-3 text-sm">{{ methods }}</p>
              </div>
            </article>
          </li>
          <!-- <li class="">
            <article class="w-96">
              <div class="">
                ...
                <p class="pt-3 text-sm">{{ questions }}</p>
              </div>
            </article>
          </li> -->
          <li class="">
          ...
          <li class="">
            <article class="w-96">
              <div class="">
                ...
                <p class="pt-3 text-sm">{{ analysis }}</p>
              </div>
            </article>
          </li>
        </ul>
